...
N 440 120 440 140 {
lab=GND}
C {devices/vsource.sym} 80 160 0 0 {name=V2 value="pulse(0 2.5 1ns 1ns 1ns 500ns 1000ns)" savecurrent=false}
...
C {sky130_fd_pr/corner.sym} 570 70 0 0 {name=CORNER only_toplevel=false corner=tt}
