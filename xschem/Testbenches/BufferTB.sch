...
C {devices/vsource.sym} 150 220 0 0 {name=V1 value="pulse(0 0.4 1ns 1ns 1ns 5ns 10ns)" savecurrent=false}
C {devices/vsource.sym} 550 80 2 0 {name=V2 value=0.4 savecurrent=false}
